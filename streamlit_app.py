...
# ---------- FIXTURES ----------
    ...
    st.caption("Showing next 5 gameweeks · FDR: 1 = easiest, 5 = hardest")
    ...
    if not bootstrap or not fixtures:
        ...
        gw_options = ["All"] + [f"Gameweek {gw}" for gw in next_gws]
        selected = st.selectbox("Select Gameweek", gw_options)
